...
from include.cache.alert_cache import fetch_cached_open_alert, save_cached_open_alert
from include.data.alert_repository import save_alert as _save_alert
