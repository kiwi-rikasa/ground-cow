 ...
 */
export const getZoneDashboardDashboardZoneGet = <ThrowOnError extends boolean = false>(options: Options<GetZoneDashboardDashboardZoneGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetZoneDashboardDashboardZoneGetResponse, GetZoneDashboardDashboardZoneGetError, ThrowOnError>({
        url: '/dashboard/zone',
        ...options
    });
};
