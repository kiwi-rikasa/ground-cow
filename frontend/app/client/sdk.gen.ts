 ...
 */
export const getZoneDashboardDashboardZoneZoneIdGet = <ThrowOnError extends boolean = false>(options: Options<GetZoneDashboardDashboardZoneZoneIdGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetZoneDashboardDashboardZoneZoneIdGetResponse, GetZoneDashboardDashboardZoneZoneIdGetError, ThrowOnError>({
 ...
 * limit: int = 30
 */
export const listFilteredEarthquakesDashboardEarthquakeListGet = <ThrowOnError extends boolean = false>(options?: Options<ListFilteredEarthquakesDashboardEarthquakeListGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ListFilteredEarthquakesDashboardEarthquakeListGetResponse, ListFilteredEarthquakesDashboardEarthquakeListGetError, ThrowOnError>({
 ...
 */
export const getEarthquakeDashboardDashboardEarthquakeGet = <ThrowOnError extends boolean = false>(options?: Options<GetEarthquakeDashboardDashboardEarthquakeGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetEarthquakeDashboardDashboardEarthquakeGetResponse, GetEarthquakeDashboardDashboardEarthquakeGetError, ThrowOnError>({
